 ...
 * </configuration></xmp>
 * 
 * Equivalently, {@link MyRandomTextWriter} also supports all the above options
 * and ones supported by {@link Tool} via the command-line.
 * 
 * To run: bin/hadoop jar hadoop-${version}-examples.jar MyRandomTextWriter
 *            [-outFormat <i>output format class</i>] <i>output</i> 
 */
public class MyRandomTextWriter extends Configured implements Tool {
  
  static int printUsage() {
    System.out.println("MyRandomTextWriter " +
  ...
  public int run(String[] args) throws Exception {    
    ...
    job.setJarByClass(MyRandomTextWriter.class);
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new MyRandomTextWriter(), args);
    System.exit(res);
  }
